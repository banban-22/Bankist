...
tabsContainer.addEventListener('click', function (e) {
  ...
  tabs.forEach(t => t.classList.remove('operaitons__tab--active'));
...
const sectinoObserver = new IntersectionObserver(revealSection, {
  root: null,
  threshold: 0.15,
});
allSections.forEach(function (section) {
  sectinoObserver.observe(section);
...
console.log(message.style.height); //only works for inline
